...
SDE_stab_func_sol_delta_T_vw = np.load(
    sde_directory_vw + "SDE_stab_func_multi_noise_sol_delta_T.npy"
)
SDE_stab_func_sol_sf_vw = np.load(
    sde_directory_vw + "SDE_stab_func_multi_noise_sol_param.npy"
)
...
for i in np.arange(0, 3600, 1):
    SDE_stab_func_sol_delta_T_vw[:, i] = SDE_stab_func_sol_delta_T_vw[:, 3601]
    SDE_stab_func_sol_sf_vw[:, i] = SDE_stab_func_sol_sf_vw[:, 3601]
    ode_data_vw[i] = ode_data_vw[3601]

# Calculate richardson number for every time step
Rb_vw = (
    params.zr
    * (params.grav / params.Tr)
    * (SDE_stab_func_sol_delta_T_vw / (params.u_range_vw**2))
)
...
plt_perturb_region = ax[0, 0].axvspan(
    params.t_span[idx_start_perturbation_vw],
    params.t_span[idx_end_perturbation_vw],
    alpha=0.3,
    color="gray",
)
...
plt_sims_delta_T_one = ax[1, 0].plot(
    params.t_span, SDE_stab_func_sol_delta_T_vw[0, :], color="black"
)
plt_det_sol = ax[1, 0].plot(
    params.t_span, ode_data_vw, color="orange", marker=".", markevery=1800, markersize=7
)
plt_sims_delta_T_mean = ax[1, 0].plot(
    params.t_span,
    np.mean(SDE_stab_func_sol_delta_T_vw, axis=0),
    color="blue",
    marker="v",
    markevery=3600,
    markersize=5,
...
plt_sims_sf_one = ax[2, 0].plot(
    params.t_span, SDE_stab_func_sol_sf_vw[0, :], color="black"
)
plt_sims_sf_mean = ax[2, 0].plot(
    params.t_span,
    np.mean(SDE_stab_func_sol_sf_vw, axis=0),
    color="blue",
    marker="v",
    markevery=3600,
    markersize=5,
...
SDE_stab_func_sol_delta_T_wv = np.load(
    sde_directory_wv + "SDE_stab_func_multi_noise_sol_delta_T.npy"
)
SDE_stab_func_sol_sf_wv = np.load(
    sde_directory_wv + "SDE_stab_func_multi_noise_sol_param.npy"
)
...
for i in np.arange(0, 3600, 1):
    ...
    SDE_stab_func_sol_delta_T_wv[:, i] = SDE_stab_func_sol_delta_T_wv[:, 3601]
    ode_data_wv[i] = ode_data_wv[3601]
...
Rb_wv = (
    params.zr
    * (params.grav / params.Tr)
    * (SDE_stab_func_sol_delta_T_wv / (params.u_range_wv**2))
)
...
plt_perturb_region = ax[0, 1].axvspan(
    params.t_span[idx_start_perturbation_wv],
    params.t_span[idx_end_perturbation_wv],
    alpha=0.3,
    color="gray",
)
...
plt_Rb_mean = ax2.plot(
    params.t_span,
    np.mean(Rb_wv, axis=0),
    color="blue",
    marker="v",
    markevery=3600,
    markersize=5,
...
plt_sims_delta_T_one = ax[1, 1].plot(
    params.t_span, SDE_stab_func_sol_delta_T_wv[0, :], color="black"
)
plt_det_sol = ax[1, 1].plot(
    params.t_span, ode_data_wv, color="orange", marker=".", markevery=1800, markersize=7
)
plt_sims_delta_T_mean = ax[1, 1].plot(
    params.t_span,
    np.mean(SDE_stab_func_sol_delta_T_wv, axis=0),
    color="blue",
    marker="v",
    markevery=3600,
    markersize=5,
...
plt_sims_sf_one = ax[2, 1].plot(
    params.t_span, SDE_stab_func_sol_sf_wv[0, :], color="black"
)
plt_sims_sf_mean = ax[2, 1].plot(
    params.t_span,
    np.mean(SDE_stab_func_sol_sf_wv, axis=0),
    color="blue",
    marker="v",
    markevery=3600,
    markersize=5,
...
fig.tight_layout()
plt.savefig(
    output_directory + "solution_with_time_dependent_u.pdf",
    bbox_inches="tight",
    dpi=300,
)

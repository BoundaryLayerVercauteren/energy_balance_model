...
plt_trans_region = ax[0, 0].axvspan(params.t_span[idx_start_trans_region_vw], params.t_span[idx_end_trans_region_vw],
                                    alpha=0.3, color='red')
plt_u = ax[0, 0].plot(params.t_span, params.u_range_vw, color='fuchsia')

colors = plt.cm.Greys(np.linspace(0.1, 0.7, int(np.shape(SDE_stab_func_sol_delta_T_vw)[0] / 2)))
ax1.set_prop_cycle('color', colors)
plt_Rb_all_sim = ax1.plot(params.t_span, Rb_vw[::100, :].T)
...
ax[0, 0].set_ylabel('u [m/s]', color='fuchsia')
# ax[0, 0].set_xlabel('time [h]')
ax[0, 0].tick_params(axis="y", labelcolor='fuchsia')
...
plt_trans_region = ax[0, 1].axvspan(params.t_span[idx_start_trans_region_wv], params.t_span[idx_end_trans_region_wv],
                                    alpha=0.3, color='red')
plt_u = ax[0, 1].plot(params.t_span, params.u_range_wv, color='fuchsia')

ax2.set_prop_cycle('color', colors)
plt_Rb_all_sim = ax2.plot(params.t_span, Rb_wv[::100, :].T)
plt_Rb_one_sim = ax2.plot(params.t_span, Rb_wv[0, :], color='blue')
plt_Rb_mean = ax2.plot(params.t_span, np.mean(Rb_wv, axis=0), color='green')

# ax[0, 1].set_ylabel('u [m/s]', color='green')
# ax[0, 0].set_xlabel('time [h]')
# ax[0, 1].tick_params(axis="y", labelcolor='green')
ax2.set_ylabel(r'$R_b$', color='green')
...
ax[0, 1].legend(handles=[plt_perturb_region, plt_trans_region, plt_u[0], plt_Rb_all_sim[0], plt_Rb_one_sim[0], plt_Rb_mean[0]],
                labels=['perturbation region', 'bistable region', 'forcing', r'$R_b$: 500 model runs',
                        r'$R_b$: 1 model run', r'$R_b$: mean'], facecolor='white', edgecolor="black",
...
plt_sims_delta_T_all = ax[1, 0].plot(params.t_span, SDE_stab_func_sol_delta_T_vw[::100, :].T)
...
plt_sims_delta_T_all = ax[1, 1].plot(params.t_span, SDE_stab_func_sol_delta_T_wv[::100, :].T)
...
plt_sims_sf_all = ax[2, 0].plot(params.t_span, SDE_stab_func_sol_sf_vw[::100, :].T)
...
plt_sims_sf_all = ax[2, 1].plot(params.t_span, SDE_stab_func_sol_sf_wv[::100, :].T)

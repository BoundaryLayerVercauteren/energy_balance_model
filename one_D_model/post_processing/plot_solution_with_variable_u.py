...
plt_Rb_mean = ax1.plot(params.t_span, np.mean(Rb_vw, axis=0), color='blue', marker='v', markevery=3600, markersize=5)
...
plt_Rb_mean = ax2.plot(params.t_span, np.mean(Rb_wv, axis=0), color='blue', marker='v', markevery=3600, markersize=5)

...
plt_Rb_mean = ax1.plot(params.t_span, np.mean(Rb_vw, axis=0), color='blue', marker='v', markevery=1000)
...
plt_det_sol = ax[1, 0].plot(params.t_span, ode_data_vw, color='orange', marker='.', markevery=1000)
plt_sims_delta_T_mean = ax[1, 0].plot(params.t_span, np.mean(SDE_stab_func_sol_delta_T_vw, axis=0), color='blue',
                                      marker='v', markevery=1000)
...
plt_Rb_mean = ax2.plot(params.t_span, np.mean(Rb_wv, axis=0), color='blue', marker='v', markevery=1000)
...
plt_det_sol = ax[1, 1].plot(params.t_span, ode_data_wv, color='orange', marker='.', markevery=1000)

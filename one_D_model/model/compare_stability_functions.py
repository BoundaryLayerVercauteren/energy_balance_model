...
def make_comparison(sol_directory_path):
    ...
    vec_vandewiel_short_tail_stab_func = np.vectorize(
        define_vandewiel_short_tail_stab_function
    )
    vec_vandewiel_long_tail_stab_func = np.vectorize(
        define_vandewiel_long_tail_stab_function
    )
    ...
    ax1.plot(
        richardson_num,
        vec_vandewiel_short_tail_stab_func(richardson_num),
        label="short tail",
        color=color[0],
        marker=markers[0],
        markevery=10,
    ...
    ax1.plot(
        richardson_num,
        vec_vandewiel_long_tail_stab_func(richardson_num),
        label="long tail",
        color=color[1],
        marker=markers[1],
        markevery=10,
    ...
    plt.savefig(
        sol_directory_path + "stability_functions.pdf", bbox_inches="tight", dpi=300
    )
